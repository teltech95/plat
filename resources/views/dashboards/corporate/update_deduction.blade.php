        ...
        @endif
          ...
          <div class="d-print-block">
            @foreach ($deduction as $detail)
             <form method="POST" action="{{route('corporate.update_deduction', ['record_ID' => $detail->record_ID])}}">
                @csrf
                <div class="card">
                   <div class="card-body">
                      <div class="form-group row">
                         ...
                         <div class="col-md-8">
                            ...
                            <input type="hidden" required data-bind="value:Code" id="DeductionRq_DeductionCode" name="DeductionCode" value="{{$detail->record_ID}}" />
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-6">
                            <input required maxlength="8" placeholder="e.g. 1234567A" class="form-control" type="text" id="DeductionRq_EcNumber" name="EcNumber" value="{{$detail->ec_number}}" />
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-6">
                            <input placeholder="e.g. 00000000A00" type="text" maxlength="16" title="ID number is required. Only letters & digits allowed!" class="form-control" id="DeductionRq_IdNumber" name="IdNumber" value="{{$detail->id_number}}" />
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-6">
                            <input type="text" maxlength="12" class="form-control" id="DeductionRq_Reference" name="Reference" value="{{$detail->transaction_reference}}" />
                            <span class="text-danger field-validation-valid" data-valmsg-for="Reference" data-valmsg-replace="true"></span>
                         </div>
                      </div>
                      <div class="form-group row">
                         ...
                         <div class="col-md-4">
                            <input onfocus="SetDates(this)" type="text" class="form-control date" required placeholder="YYYY-MM-DD" id="DeductionRq_StartDate" name="StartDate" value="{{$detail->deductions_start_date}}" />
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-4">
                            <input onfocus="SetDates(this)" type="text" class="form-control date" placeholder="YYYY-MM-DD" id="DeductionRq_EndDate" name="EndDate" value="{{$detail->deductions_end_date}}" />
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-4">
                            <div class="input-group">
                               <input required type="number" class="form-control"  name="Amount" value="{{$detail->installment_amount}}" />
                               <div class="input-group-append input-group-text">Cents</div>
                            </div>
                            <span class="text-danger field-validation-valid" data-valmsg-for="Amount" data-valmsg-replace="true"></span>
                         </div>
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-8">
                            <input maxlength="64" class="form-control" type="text" id="DeductionRq_Name" name="Name" value="{{$detail->first_name}}" />
                            <span class="text-danger field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true"></span>
                         </div>
                      </div>
                      <div class="form-group row">
                         ...
                         <div class="col-md-8">
                            <input maxlength="64" class="form-control" type="text" id="DeductionRq_Surname" name="Surname" value="{{$detail->last_name}}" />
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-4">
                            <div class="input-group">
                               <input data-bind="textinput:Amount" required type="number" class="form-control" id="DeductionRq_Amount" name="Amount" value="{{$detail->installment_amount}}" />
                               <div class="input-group-append input-group-text">Cents</div>
                            </div>
                            <span class="text-danger field-validation-valid" data-valmsg-for="Amount" data-valmsg-replace="true"></span>
                         </div>
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-md-4">
                            <div class="input-group">
                               <input data-bind="textinput:Amount" required type="number" class="form-control" id="DeductionRq_Amount" name="Amount" value="{{$detail->installment_amount}}" />
                               <div class="input-group-append input-group-text">tfa</div>
                            </div>
                            <span class="text-danger field-validation-valid" data-valmsg-for="Amount" data-valmsg-replace="true"></span>
                         </div>
                         <div class="col-md-4"><input data-bind="value:AmountInCur" readonly class="form-control" /></div>
                   ...
                   <div class="card-footer">
                      <button class="btn btn-success" data-bind="enable:IsValid"><i class="fa fa-save"></i>&nbsp;Update</button>
                   </div>
