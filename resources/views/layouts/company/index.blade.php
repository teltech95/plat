      ...
      <div class="wrapper">
         <nav id="sidebar" class="d-print-none">
            <ul class="list-unstyled" style="margin-top:0px">
               <li><a class="text-white-50" href="/company/dashboard"><i class="text-white fa fa-home w24"></i> Dashboard</a></li>
               <li class="dropdown-divider"></li>
               <li><a class="text-white-50" href="{{route('company.deduction')}}"><i class="text-white fa fa-search-plus w24"></i> Update Record</a></li>
               <li><a class="text-white-50" href="{{route('company.list')}}"><i class="text-white fa fa-search-plus w24"></i> View Records</a></li>

               <li><a class="text-white-50" href="{{route('company.getCompany')}}"><i class="text-primary fa fa-file-import w24"></i> Add Company</a></li>
               <li><a class="text-white-50" href="{{route('company.viewcompany')}}"><i class="text-info fa fa-paper-plane w24"></i> View Companies</a></li>
            ...
            <header>
               <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light border-dark fixed-top shadow-sm bg-light" style="height:68px;">
                  <div class="container-fluid">
                     ...
                     <a class="navbar-brand" href="/company/dashboard"><img src="" style="height:32px" />Public Service Commission</a>
                     <div class="navbar-collapse collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav">
                           <li class="nav-item">
                              <a class="btn btn-outline-primary" title="Create new record.." href="{{route('company.getCompany')}}"><i class="fa fa-edit"></i> Add new company..</a>
                           </li>
                           <li class="nav-item">
