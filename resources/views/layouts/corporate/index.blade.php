...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <title>Dashboard - NDASENDA™</title>
      <!-- CSRF Token -->
      ...
      <div class="wrapper">
         <nav id="sidebar" class="d-print-none">
            <ul class="list-unstyled" style="margin-top:0px">
               <li><a class="text-white-50" href="/corporate/dashboard"><i class="text-white fa fa-home w24"></i> Dashboard</a></li>
               <li class="dropdown-divider"></li>
               <li><a class="text-white-50" href="{{route('corporate.deduction')}}"><i class="text-white fa fa-search-plus w24"></i> View records</a></li>
               {{-- <li><a class="text-white-50" href="{{route('corporate.import_deduction')}}"><i class="text-primary fa fa-file-import w24"></i> Import bulk records</a></li> --}}
               <li class="dropdown-divider"></li>
               <li><a class="text-white-50" href="{{route('corporate.rejected_deduction')}}"><i class="text-success fa fa-check-circle w24"></i> Rejected</a></li>
               <li><a class="text-white-50" href="{{route('corporate.approved_deduction')}}"><i class="text-white fa fa-list-alt w24"></i> Accepted</a></li>
            ...
            <header>
               <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light border-dark fixed-top shadow-sm bg-light" style="height:68px;">
                  <div class="container-fluid">
                     ...
                     <a class="navbar-brand" href="/corporate/dashboard"><img src="" style="height:32px" />Corporate Dashboard</a>
                     <div class="navbar-collapse collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav">
                           <li class="nav-item">
                              <a class="btn btn-outline-primary" title="Create new record.." href="{{route('corporate.add_deduction')}}"><i class="fa fa-edit"></i> Create new record..</a>
                           </li>
                           <li class="nav-item">
